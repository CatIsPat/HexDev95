...
import { Sparkles, Loader2, Image as ImageIcon, Type, Zap, Settings2, RefreshCw } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-emerald-500/30">
      ...
      <button
        onClick={handleReset}
        className="fixed top-4 left-4 z-50 p-3 bg-black/50 hover:bg-red-500/20 text-white/60 hover:text-red-400 border border-white/10 hover:border-red-500/50 rounded-full backdrop-blur-md transition-all shadow-lg"
        title="Reset All"
      >
        <RefreshCw size={20} />
      </button>
      ...
      <div className="max-w-3xl mx-auto px-4 pt-8 pb-4">
        <div className="flex items-center justify-between mb-6 pl-12"> {/* Added padding-left to avoid overlap with refresh button */}
